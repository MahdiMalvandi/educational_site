...
class LoginView(APIView):
    ...
    @swagger_auto_schema(
        request_body=openapi.Schema(tags=['Users'],
    ...
    def post(self, request, *args, **kwargs):
        ...
        if user.check_password(password):
            ...
            request.session['email_verification'] = user.email
...
class RegisterAndSendEmail(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if user.is_valid():
            user.save()
            request.session['email_verification'] = email
...
class GetUserToken(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        """
        user_email = request.session.get('email_verification', None)
...
class ForgotPasswordSendEmailApiView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return Response({
            'message': "Email sent successfully. Please proceed to the reset-password/confirm/ endpoint with the provided code."},
    ...
    @swagger_auto_schema(
        request_body=openapi.Schema(tags=['Users'],
            ...
            properties={
                ...
                'new_password': openapi.Schema(type=openapi.TYPE_STRING, description="The new password to be set."),
                'code': openapi.Schema(type=openapi.TYPE_STRING,
                                       description="The verification code received for password reset.")
            },
